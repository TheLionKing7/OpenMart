/** Tier-1 wholesalers — VWL owners who fulfill orders. Not open markets. */
...
export function distributorsForMarket(market: string): Distributor[] {
  return distributors.filter((d) => d.servesMarkets.includes(market));
}
